...
public class ParrotBot implements LongPollingSingleThreadUpdateConsumer {
    ...
    public ParrotBot(String botToken, String botUserName, String groupId) {
    ...
    private void sendWelcomeMessage() {
        ...
        SendMessage welcomeMessage = new SendMessage(groupId, welcomeText.replace("[BOT_NAME]", botUserName));
        try {
